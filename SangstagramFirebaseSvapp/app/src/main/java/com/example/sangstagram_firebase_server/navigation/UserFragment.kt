...
import com.example.sangstagram_firebase_server.LoginActivity
import com.example.sangstagram_firebase_server.MainActivity
    ...
    fun requestFollow() {
        ...
        firestore?.runTransaction { transaction ->
            ...
            if(followDTO.followings.containsKey(uid)) {
                ...
                //It add following third person when a third person do net follow me
                followDTO?.followingCount = followDTO?.followingCount +1
